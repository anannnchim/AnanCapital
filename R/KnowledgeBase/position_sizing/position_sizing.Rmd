...
The Kelly Criterion provides a way to calculate the optimal fraction of wealth to invest in each available opportunity to maximize the exponential rate of growth of the investor's wealth.
